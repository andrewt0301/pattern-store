...
public interface TeamService {
     ...
     * @implNote If team for update does not have invitation code,
     *  it will be taken from existing team by the specified id.
     *  If invitation of code of team for update differs from code of
     *  the existing team, invitation code will be generated by server.
